...
create_generated_clock -name {sram_clk_100_20} -source [get_ports {CLOCK_50}] -duty_cycle 20.00 -multiply_by 2 -divide_by 1 -phase -36.00 -master_clock {main_clk_50} [get_pins {sram_pll|altpll_component|auto_generated|pll1|clk[1]}]
