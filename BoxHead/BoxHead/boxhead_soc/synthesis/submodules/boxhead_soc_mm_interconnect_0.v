...
module boxhead_soc_mm_interconnect_0 (
		...
		output wire [3:0]  copy_engine_core_Copy_Engine_Slave_address,         //           copy_engine_core_Copy_Engine_Slave.address
		output wire        copy_engine_core_Copy_Engine_Slave_write,           //                                             .write
		output wire        copy_engine_core_Copy_Engine_Slave_read,            //                                             .read
		input  wire [31:0] copy_engine_core_Copy_Engine_Slave_readdata,        //                                             .readdata
		output wire [31:0] copy_engine_core_Copy_Engine_Slave_writedata,       //                                             .writedata
		output wire [3:0]  copy_engine_core_Copy_Engine_Slave_byteenable,      //                                             .byteenable
		output wire        copy_engine_core_Copy_Engine_Slave_chipselect,      //                                             .chipselect
	...
	wire   [31:0] copy_engine_core_copy_engine_slave_agent_m0_readdata;                               // copy_engine_core_Copy_Engine_Slave_translator:uav_readdata -> copy_engine_core_Copy_Engine_Slave_agent:m0_readdata
	wire          copy_engine_core_copy_engine_slave_agent_m0_waitrequest;                            // copy_engine_core_Copy_Engine_Slave_translator:uav_waitrequest -> copy_engine_core_Copy_Engine_Slave_agent:m0_waitrequest
	wire          copy_engine_core_copy_engine_slave_agent_m0_debugaccess;                            // copy_engine_core_Copy_Engine_Slave_agent:m0_debugaccess -> copy_engine_core_Copy_Engine_Slave_translator:uav_debugaccess
	wire   [28:0] copy_engine_core_copy_engine_slave_agent_m0_address;                                // copy_engine_core_Copy_Engine_Slave_agent:m0_address -> copy_engine_core_Copy_Engine_Slave_translator:uav_address
	wire    [3:0] copy_engine_core_copy_engine_slave_agent_m0_byteenable;                             // copy_engine_core_Copy_Engine_Slave_agent:m0_byteenable -> copy_engine_core_Copy_Engine_Slave_translator:uav_byteenable
	wire          copy_engine_core_copy_engine_slave_agent_m0_read;                                   // copy_engine_core_Copy_Engine_Slave_agent:m0_read -> copy_engine_core_Copy_Engine_Slave_translator:uav_read
	wire          copy_engine_core_copy_engine_slave_agent_m0_readdatavalid;                          // copy_engine_core_Copy_Engine_Slave_translator:uav_readdatavalid -> copy_engine_core_Copy_Engine_Slave_agent:m0_readdatavalid
	wire          copy_engine_core_copy_engine_slave_agent_m0_lock;                                   // copy_engine_core_Copy_Engine_Slave_agent:m0_lock -> copy_engine_core_Copy_Engine_Slave_translator:uav_lock
	wire   [31:0] copy_engine_core_copy_engine_slave_agent_m0_writedata;                              // copy_engine_core_Copy_Engine_Slave_agent:m0_writedata -> copy_engine_core_Copy_Engine_Slave_translator:uav_writedata
	wire          copy_engine_core_copy_engine_slave_agent_m0_write;                                  // copy_engine_core_Copy_Engine_Slave_agent:m0_write -> copy_engine_core_Copy_Engine_Slave_translator:uav_write
	wire    [2:0] copy_engine_core_copy_engine_slave_agent_m0_burstcount;                             // copy_engine_core_Copy_Engine_Slave_agent:m0_burstcount -> copy_engine_core_Copy_Engine_Slave_translator:uav_burstcount
	wire          copy_engine_core_copy_engine_slave_agent_rf_source_valid;                           // copy_engine_core_Copy_Engine_Slave_agent:rf_source_valid -> copy_engine_core_Copy_Engine_Slave_agent_rsp_fifo:in_valid
	wire  [107:0] copy_engine_core_copy_engine_slave_agent_rf_source_data;                            // copy_engine_core_Copy_Engine_Slave_agent:rf_source_data -> copy_engine_core_Copy_Engine_Slave_agent_rsp_fifo:in_data
	wire          copy_engine_core_copy_engine_slave_agent_rf_source_ready;                           // copy_engine_core_Copy_Engine_Slave_agent_rsp_fifo:in_ready -> copy_engine_core_Copy_Engine_Slave_agent:rf_source_ready
	wire          copy_engine_core_copy_engine_slave_agent_rf_source_startofpacket;                   // copy_engine_core_Copy_Engine_Slave_agent:rf_source_startofpacket -> copy_engine_core_Copy_Engine_Slave_agent_rsp_fifo:in_startofpacket
	wire          copy_engine_core_copy_engine_slave_agent_rf_source_endofpacket;                     // copy_engine_core_Copy_Engine_Slave_agent:rf_source_endofpacket -> copy_engine_core_Copy_Engine_Slave_agent_rsp_fifo:in_endofpacket
	wire          copy_engine_core_copy_engine_slave_agent_rsp_fifo_out_valid;                        // copy_engine_core_Copy_Engine_Slave_agent_rsp_fifo:out_valid -> copy_engine_core_Copy_Engine_Slave_agent:rf_sink_valid
	wire  [107:0] copy_engine_core_copy_engine_slave_agent_rsp_fifo_out_data;                         // copy_engine_core_Copy_Engine_Slave_agent_rsp_fifo:out_data -> copy_engine_core_Copy_Engine_Slave_agent:rf_sink_data
	wire          copy_engine_core_copy_engine_slave_agent_rsp_fifo_out_ready;                        // copy_engine_core_Copy_Engine_Slave_agent:rf_sink_ready -> copy_engine_core_Copy_Engine_Slave_agent_rsp_fifo:out_ready
	wire          copy_engine_core_copy_engine_slave_agent_rsp_fifo_out_startofpacket;                // copy_engine_core_Copy_Engine_Slave_agent_rsp_fifo:out_startofpacket -> copy_engine_core_Copy_Engine_Slave_agent:rf_sink_startofpacket
	wire          copy_engine_core_copy_engine_slave_agent_rsp_fifo_out_endofpacket;                  // copy_engine_core_Copy_Engine_Slave_agent_rsp_fifo:out_endofpacket -> copy_engine_core_Copy_Engine_Slave_agent:rf_sink_endofpacket
	wire          cmd_mux_src_valid;                                                                  // cmd_mux:src_valid -> copy_engine_core_Copy_Engine_Slave_agent:cp_valid
	wire  [106:0] cmd_mux_src_data;                                                                   // cmd_mux:src_data -> copy_engine_core_Copy_Engine_Slave_agent:cp_data
	wire          cmd_mux_src_ready;                                                                  // copy_engine_core_Copy_Engine_Slave_agent:cp_ready -> cmd_mux:src_ready
	wire   [14:0] cmd_mux_src_channel;                                                                // cmd_mux:src_channel -> copy_engine_core_Copy_Engine_Slave_agent:cp_channel
	wire          cmd_mux_src_startofpacket;                                                          // cmd_mux:src_startofpacket -> copy_engine_core_Copy_Engine_Slave_agent:cp_startofpacket
	wire          cmd_mux_src_endofpacket;                                                            // cmd_mux:src_endofpacket -> copy_engine_core_Copy_Engine_Slave_agent:cp_endofpacket
	...
	wire          copy_engine_core_copy_engine_slave_agent_rp_valid;                                  // copy_engine_core_Copy_Engine_Slave_agent:rp_valid -> router_002:sink_valid
	wire  [106:0] copy_engine_core_copy_engine_slave_agent_rp_data;                                   // copy_engine_core_Copy_Engine_Slave_agent:rp_data -> router_002:sink_data
	wire          copy_engine_core_copy_engine_slave_agent_rp_ready;                                  // router_002:sink_ready -> copy_engine_core_Copy_Engine_Slave_agent:rp_ready
	wire          copy_engine_core_copy_engine_slave_agent_rp_startofpacket;                          // copy_engine_core_Copy_Engine_Slave_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire          copy_engine_core_copy_engine_slave_agent_rp_endofpacket;                            // copy_engine_core_Copy_Engine_Slave_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire          copy_engine_core_copy_engine_slave_agent_rdata_fifo_src_valid;                      // copy_engine_core_Copy_Engine_Slave_agent:rdata_fifo_src_valid -> avalon_st_adapter:in_0_valid
	wire   [33:0] copy_engine_core_copy_engine_slave_agent_rdata_fifo_src_data;                       // copy_engine_core_Copy_Engine_Slave_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	wire          copy_engine_core_copy_engine_slave_agent_rdata_fifo_src_ready;                      // avalon_st_adapter:in_0_ready -> copy_engine_core_Copy_Engine_Slave_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_out_0_valid;                                                      // avalon_st_adapter:out_0_valid -> copy_engine_core_Copy_Engine_Slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_out_0_data;                                                       // avalon_st_adapter:out_0_data -> copy_engine_core_Copy_Engine_Slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_out_0_ready;                                                      // copy_engine_core_Copy_Engine_Slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire    [0:0] avalon_st_adapter_out_0_error;                                                      // avalon_st_adapter:out_0_error -> copy_engine_core_Copy_Engine_Slave_agent:rdata_fifo_sink_error
	...
	) copy_engine_core_copy_engine_slave_translator (
		.clk                    (clk_0_clk_clk),                                             //                      clk.clk
		.reset                  (copy_engine_core_RESET_reset_bridge_in_reset_reset),        //                    reset.reset
		.uav_address            (copy_engine_core_copy_engine_slave_agent_m0_address),       // avalon_universal_slave_0.address
		.uav_burstcount         (copy_engine_core_copy_engine_slave_agent_m0_burstcount),    //                         .burstcount
		.uav_read               (copy_engine_core_copy_engine_slave_agent_m0_read),          //                         .read
		.uav_write              (copy_engine_core_copy_engine_slave_agent_m0_write),         //                         .write
		.uav_waitrequest        (copy_engine_core_copy_engine_slave_agent_m0_waitrequest),   //                         .waitrequest
		.uav_readdatavalid      (copy_engine_core_copy_engine_slave_agent_m0_readdatavalid), //                         .readdatavalid
		.uav_byteenable         (copy_engine_core_copy_engine_slave_agent_m0_byteenable),    //                         .byteenable
		.uav_readdata           (copy_engine_core_copy_engine_slave_agent_m0_readdata),      //                         .readdata
		.uav_writedata          (copy_engine_core_copy_engine_slave_agent_m0_writedata),     //                         .writedata
		.uav_lock               (copy_engine_core_copy_engine_slave_agent_m0_lock),          //                         .lock
		.uav_debugaccess        (copy_engine_core_copy_engine_slave_agent_m0_debugaccess),   //                         .debugaccess
		.av_address             (copy_engine_core_Copy_Engine_Slave_address),                //      avalon_anti_slave_0.address
		.av_write               (copy_engine_core_Copy_Engine_Slave_write),                  //                         .write
		.av_read                (copy_engine_core_Copy_Engine_Slave_read),                   //                         .read
		.av_readdata            (copy_engine_core_Copy_Engine_Slave_readdata),               //                         .readdata
		.av_writedata           (copy_engine_core_Copy_Engine_Slave_writedata),              //                         .writedata
		.av_byteenable          (copy_engine_core_Copy_Engine_Slave_byteenable),             //                         .byteenable
		.av_chipselect          (copy_engine_core_Copy_Engine_Slave_chipselect),             //                         .chipselect
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) copy_engine_core_copy_engine_slave_agent (
		.clk                     (clk_0_clk_clk),                                                       //             clk.clk
		.reset                   (copy_engine_core_RESET_reset_bridge_in_reset_reset),                  //       clk_reset.reset
		.m0_address              (copy_engine_core_copy_engine_slave_agent_m0_address),                 //              m0.address
		.m0_burstcount           (copy_engine_core_copy_engine_slave_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (copy_engine_core_copy_engine_slave_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (copy_engine_core_copy_engine_slave_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (copy_engine_core_copy_engine_slave_agent_m0_lock),                    //                .lock
		.m0_readdata             (copy_engine_core_copy_engine_slave_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (copy_engine_core_copy_engine_slave_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (copy_engine_core_copy_engine_slave_agent_m0_read),                    //                .read
		.m0_waitrequest          (copy_engine_core_copy_engine_slave_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (copy_engine_core_copy_engine_slave_agent_m0_writedata),               //                .writedata
		.m0_write                (copy_engine_core_copy_engine_slave_agent_m0_write),                   //                .write
		.rp_endofpacket          (copy_engine_core_copy_engine_slave_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (copy_engine_core_copy_engine_slave_agent_rp_ready),                   //                .ready
		.rp_valid                (copy_engine_core_copy_engine_slave_agent_rp_valid),                   //                .valid
		.rp_data                 (copy_engine_core_copy_engine_slave_agent_rp_data),                    //                .data
		.rp_startofpacket        (copy_engine_core_copy_engine_slave_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (copy_engine_core_copy_engine_slave_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (copy_engine_core_copy_engine_slave_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (copy_engine_core_copy_engine_slave_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (copy_engine_core_copy_engine_slave_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (copy_engine_core_copy_engine_slave_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (copy_engine_core_copy_engine_slave_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (copy_engine_core_copy_engine_slave_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (copy_engine_core_copy_engine_slave_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (copy_engine_core_copy_engine_slave_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (copy_engine_core_copy_engine_slave_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_out_0_ready),                                       // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_out_0_valid),                                       //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_out_0_data),                                        //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_out_0_error),                                       //                .error
		.rdata_fifo_src_ready    (copy_engine_core_copy_engine_slave_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (copy_engine_core_copy_engine_slave_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (copy_engine_core_copy_engine_slave_agent_rdata_fifo_src_data),        //                .data
	...
	) copy_engine_core_copy_engine_slave_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                                       //       clk.clk
		.reset             (copy_engine_core_RESET_reset_bridge_in_reset_reset),                  // clk_reset.reset
		.in_data           (copy_engine_core_copy_engine_slave_agent_rf_source_data),             //        in.data
		.in_valid          (copy_engine_core_copy_engine_slave_agent_rf_source_valid),            //          .valid
		.in_ready          (copy_engine_core_copy_engine_slave_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (copy_engine_core_copy_engine_slave_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (copy_engine_core_copy_engine_slave_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (copy_engine_core_copy_engine_slave_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (copy_engine_core_copy_engine_slave_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (copy_engine_core_copy_engine_slave_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (copy_engine_core_copy_engine_slave_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (copy_engine_core_copy_engine_slave_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
	...
	boxhead_soc_mm_interconnect_0_router_002 router_002 (
		.sink_ready         (copy_engine_core_copy_engine_slave_agent_rp_ready),         //      sink.ready
		.sink_valid         (copy_engine_core_copy_engine_slave_agent_rp_valid),         //          .valid
		.sink_data          (copy_engine_core_copy_engine_slave_agent_rp_data),          //          .data
		.sink_startofpacket (copy_engine_core_copy_engine_slave_agent_rp_startofpacket), //          .startofpacket
		.sink_endofpacket   (copy_engine_core_copy_engine_slave_agent_rp_endofpacket),   //          .endofpacket
		.clk                (clk_0_clk_clk),                                             //       clk.clk
		.reset              (copy_engine_core_RESET_reset_bridge_in_reset_reset),        // clk_reset.reset
	...
	boxhead_soc_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_0_data      (copy_engine_core_copy_engine_slave_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (copy_engine_core_copy_engine_slave_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (copy_engine_core_copy_engine_slave_agent_rdata_fifo_src_ready), //         .ready
